...
RUN wget --no-check-certificate 'https://drive.google.com/uc?export=download&id=13COShQefhIQA0b2Yr2-9Fz-5pDlVnl5-' -O IoTData.txt
...
RUN git clone --depth 1 https://github.com/151756210-myseneca/raspberrypi.git
